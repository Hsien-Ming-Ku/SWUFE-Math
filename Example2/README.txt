...
!!!! So please also ensure that the source for academic research only,  not used for any commercial purposes. I put them here just for the convenience of my research program.
!! Good news: the preprint of our paper [1] has been cited by "Moteki Nobuhiro, Kouji Adachi, Sho Ohata, Atsushi Yoshida, Tomoo Harigaya, Makoto Koike, and Yutaka Kondo. "Anthropogenic 
iron oxide aerosols enhance atmospheric heating." Nature Communications, 8(1) (2017): 15329."

PS: we also have other related matrices (since they are dense (or we can design the subroutine for implementing the dense matrix-vector product), but we don't upload them. If necessary, 
you can contact with us for using the Krylov subspace solvers))
